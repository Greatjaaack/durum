...
from app.handlers.close_wizard import (
    ...
    CLOSE_WIZARD_DONE_KEY,
    CLOSE_WIZARD_FINISH_CONFIRM_KEY,
    CLOSE_WIZARD_INDEX_KEY,
    CLOSE_WIZARD_ITEMS,
    CLOSE_WIZARD_MESSAGE_CHAT_KEY,
    CLOSE_WIZARD_MESSAGE_ID_KEY,
    CLOSE_WIZARD_PHOTO_REQUIRED_ITEMS,
    CLOSE_WIZARD_RESIDUAL_INDEX,
    CLOSE_WIZARD_SECTION_ITEMS,
    CLOSE_WIZARD_SECTION_KEY,
    CLOSE_WIZARD_SHIFT_KEY,
    CLOSE_WIZARD_STARTED_AT_KEY,
    CLOSE_WIZARD_STEPS_TOTAL,
    CLOSE_WIZARD_TOTAL,
    CLOSE_WIZARD_VALUES_KEY,
    INPUT_RULES,
    CloseInputRule,
    CloseItemType,
    CloseWizardItem,
    build_close_done_details_keyboard,
    build_close_done_details_text,
    ...
    close_residual_display,
    close_residual_display_unit,
    ...
    close_wizard_parse_context,
    close_wizard_parse_numeric_input,
    close_wizard_restore_completed,
...
from app.handlers.media import download_media_to_disk
...
# ---------------------------------------------------------------------------
# Совместимость: старые приватные имена внутри shift.py теперь — алиасы к
# публичному API из close_wizard.py. Это позволяет не править вызовы внутри
# существующих handlers/finalize-функций при поэтапном выносе модулей.
# ---------------------------------------------------------------------------
_close_wizard_item_requires_photo = close_wizard_item_requires_photo
_close_wizard_restore_completed = close_wizard_restore_completed
_close_wizard_next_section_after_completion = close_wizard_next_section_after_completion
_close_wizard_missing_items = close_wizard_missing_items
_close_wizard_build_screen = build_close_wizard_screen
_close_wizard_parse_context = close_wizard_parse_context
_close_wizard_item_index_by_residual_key = close_wizard_item_index_by_residual_key
_close_wizard_parse_numeric_input = close_wizard_parse_numeric_input
_get_normalized_residual = close_residual_normalized
_get_display_residual = close_residual_display
_get_residual_display_unit = close_residual_display_unit
_close_duration_label = close_duration_label
_format_hhmm = format_hhmm
_build_close_done_summary_text = build_close_done_summary_text
_build_close_done_summary_keyboard = build_close_done_summary_keyboard
_build_close_done_details_text = build_close_done_details_text
_build_close_done_details_keyboard = build_close_done_details_keyboard
...
async def open_checklist_photo_input(
    ...
    local_path = await download_media_to_disk(
        bot=bot,
